...
enum {screen_splash, screen_main, screen_settings, screen_debug, screen_debug2, screen_last_scrollable, screen_edit_presets, screen_edit_preset, screen_edit_scan, screen_edit_contrast, screen_LAST};
