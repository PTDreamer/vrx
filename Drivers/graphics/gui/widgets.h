...
typedef enum widgetFieldType {field_float, field_integer, field_uinteger16, field_uinteger32, field_bmp, field_string}widgetFieldType;
...
enum {screen_splash, screen_main, screen_settings, screen_last_scrollable, screen_edit_presets, screen_edit_preset, screen_edit_scan, screen_edit_rssi, screen_edit_contrast, screen_edit_diversity, screen_LAST};
